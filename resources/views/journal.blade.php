...
<head>
    ...
    <title>Jurnal Pribadi - Asisten AI</title>
        ...
        <div class="flex-1 overflow-auto">
            ...
            <header class="bg-white border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Jurnal Pribadi</h1>
                        <p class="text-gray-600">Catat pikiran dan pengalaman Anda</p>
                    </div>
            ...
            <main class="p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-semibold text-gray-900">Jurnal Pribadi</h2>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 mb-4">Mulai dengan menulis entri jurnal pertama Anda</p>
